...
# Compatibility constant. Local-first configuration changes the effective route
# only when ModelRouter is constructed without an explicit model tuple.
        ...
        for model in self.models:
            ...
            try:
                ...
                if not validate(value):
                    ...
                    continue
                records.append(
                    AttemptRecord(model, "ok", duration, provider_kind=provider_kind)
                )
