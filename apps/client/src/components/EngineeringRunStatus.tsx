...
const styles = StyleSheet.create({
  card: { marginHorizontal: 24, marginTop: 12, padding: 14, borderRadius: 14, backgroundColor: 'rgba(225,240,248,0.72)', borderWidth: 1, borderColor: 'rgba(32,116,151,0.18)' },
  row: { flexDirection: 'row', justifyContent: 'space-between', gap: 12 },
  title: { color: '#12384a', fontWeight: '700' }, spec: { color: '#427184', fontSize: 12 },
  progress: { color: '#2484aa', marginTop: 9, letterSpacing: 1 }, caption: { color: '#56727d', marginTop: 7, fontSize: 12 },
  actions: { flexDirection: 'row', gap: 18, marginTop: 10 }, action: { color: '#176d91', fontWeight: '600' },
});
