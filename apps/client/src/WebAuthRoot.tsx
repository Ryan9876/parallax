...
const styles = StyleSheet.create({
  ...
  ambientOne: { position: 'absolute', width: 560, height: 560, borderRadius: 280, backgroundColor: 'rgba(143,99,216,0.14)', left: -190, top: -210 },
  ambientTwo: { position: 'absolute', width: 480, height: 480, borderRadius: 240, backgroundColor: 'rgba(125,231,255,0.06)', right: -180, bottom: -210 },
  gatePanel: { width: '100%', maxWidth: 560, alignItems: 'center', paddingHorizontal: 48, paddingVertical: 50, borderRadius: 30, backgroundColor: 'rgba(17,21,37,0.82)', borderWidth: 1, borderColor: palette.borderStrong },
  ...
  accountLayerCompact: { top: 9, right: 132 },
  ...
  accessPanelCompact: { position: 'absolute', top: 53, right: -120, maxHeight: 560, marginTop: 0, padding: 16, borderRadius: 20 },
