...
old_status = "P2-V0.23.10 HOSTED MODEL ESCALATION IMPLEMENTED + FOCUSED-VALIDATED / RELEASE GATES + DEPLOYMENT PENDING"
new_status = "P2-V0.23.10 HOSTED MODEL ESCALATION DEPLOYMENT-VERIFIED + PRODUCTION-ACCEPTED"
if old_status not in text:
    raise SystemExit("P2-V0.23.10 top status anchor changed")
text = text.replace(old_status, new_status, 1)

old_section = '''## P2-V0.23.10 — Hosted model escalation ordering — IMPLEMENTED / FOCUSED-VALIDATED / RELEASE GATES + DEPLOYMENT PENDING
...
'''
new_section = '''## P2-V0.23.10 — Hosted model escalation ordering — DEPLOYMENT-VERIFIED / PRODUCTION-ACCEPTED
...
if old_section not in text:
    raise SystemExit("P2-V0.23.10 section anchor changed")
text = text.replace(old_section, new_section, 1)

old_api = '''Current deployment-verified production API:
...
'''
new_api = '''Current deployment-verified production API:
...
if old_api not in text:
    raise SystemExit("production API record anchor changed")
