...
## P2-V0.23.39 — canonical empty-tree replay compatibility — PRODUCTION-ACCEPTED / W9-S1 SOURCE DELIVERY SUCCEEDED / HUMAN REVIEW REQUIRED
...
## P2-V0.23.38 — provider-owned greenfield commit timestamp compatibility — PRODUCTION-BEHAVIOR-ACCEPTED / LATER CANONICAL EMPTY-TREE PROVIDER READBACK BLOCKER EXPOSED
